...
TOPICS = [
    ...
    (
        ...
        "Запутанные квантовые состояния демонстрируют корреляции измерений.",
    ),
    ...
    (
        ...
        "Железные дороги стали ключевой инфраструктурой промышленной эпохи.",
    ),
    (
        "защита персональных данных",
        "Персональные данные требуют контроля доступа и минимизации сбора.",
    ),
    (
        "solar panel efficiency",
        "Photovoltaic efficiency measures how much sunlight becomes electricity.",
    ),
    (
    ...
    (
        ...
        "A Python context manager controls setup and cleanup around a block.",
    ),
    ("ocean acidification", "Oceans become more acidic as they absorb atmospheric carbon dioxide."),
    (
        "renewable energy storage",
        "Batteries and pumped hydro can balance variable renewable generation.",
    ),
    ...
    (
        "Roman architecture",
        "Roman builders used arches, vaults, concrete, and monumental public spaces.",
    ),
